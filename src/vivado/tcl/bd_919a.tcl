...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:ip:sc_sc2axi:1.0\
xilinx.com:ip:sc_axi2sc:1.0\
xilinx.com:ip:xlconstant:1.1\
xilinx.com:ip:proc_sys_reset:5.0\
xilinx.com:ip:sc_exit:1.0\
xilinx.com:ip:sc_node:1.0\
xilinx.com:ip:sc_mmu:1.0\
xilinx.com:ip:sc_si_converter:1.0\
xilinx.com:ip:sc_transaction_regulator:1.0\
xilinx.com:ip:sc_switchboard:1.0\
"
...
proc create_hier_cell_m01_nodes { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net m_axi_aclk_1 [get_bd_pins m_axi_aclk] [get_bd_pins m01_ar_node/m_sc_aclk] [get_bd_pins m01_r_node/s_sc_aclk]
  connect_bd_net -net m_axi_aresetn_1 [get_bd_pins m_axi_aresetn] [get_bd_pins m01_ar_node/m_sc_aresetn] [get_bd_pins m01_r_node/s_sc_aresetn]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins m01_ar_node/s_sc_aclk] [get_bd_pins m01_r_node/m_sc_aclk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins m01_ar_node/s_sc_aresetn] [get_bd_pins m01_r_node/m_sc_aresetn]
